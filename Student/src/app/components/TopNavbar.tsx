...
const navLinks = [
  ...
  { path: "/class-performance", label: "My Class Performance", icon: Users },
  { path: "/engagement-history", label: "Engagement History", icon: Activity },
  { path: "/teacher-feedback", label: "Teacher Feedback", icon: MessageSquare },
  { path: "/class-insights", label: "Class Insights", icon: BarChart3 },
];
    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div
            className="absolute -top-10 left-1/4 w-64 h-64 bg-primary/8 rounded-full blur-3xl"
            animate={{
              x: [0, 30, 0],
              y: [0, 20, 0],
              scale: [1, 1.1, 1],
          ...
          />
          <motion.div
            className="absolute -top-10 right-1/3 w-56 h-56 bg-secondary/10 rounded-full blur-3xl"
            animate={{
              x: [0, -25, 0],
              y: [0, 15, 0],
              scale: [1, 1.15, 1],
          ...
          />
          <motion.div
            className="absolute -top-10 right-1/4 w-48 h-48 bg-purple-400/8 rounded-full blur-3xl"
            animate={{
              x: [0, 20, 0],
              y: [0, -20, 0],
              scale: [1, 1.2, 1],
        ...
        <div className="relative z-10 max-w-[1920px] mx-auto px-8 lg:px-20 h-full flex items-center justify-between">
          ...
          <Link to="/" className="flex flex-col">
            ...
            <span className="text-[13px] text-[#64748B] mt-1 tracking-[0.02em]">
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link key={link.path} to={link.path}>
                  <motion.div
                    className={`relative px-5 py-2.5 rounded-xl transition-all duration-250 ${
                      isActive
          ...
          <div className="flex items-center gap-3">
                ...
                {isNotificationOpen && (
                  ...
                  >
                    ...
                    <div className="max-h-96 overflow-y-auto">
                      {[
                        { title: "New Feedback", message: "Dr. Smith left feedback on your performance", time: "5 min ago" },
                        { title: "Class Average Updated", message: "Class 10A engagement is now 76%", time: "1 hour ago" },
                        { title: "Achievement Unlocked", message: "You've maintained 80%+ for a week!", time: "2 hours ago" },
                      ].map((notification, index) => (
                        <motion.div
                          key={index}
                          className="p-4 hover:bg-accent/30 transition-colors cursor-pointer border-b border-border/50 last:border-0"
                          whileHover={{ x: 4 }}
                        >
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              >
                ...
                <ChevronDown
                  className={`hidden md:block w-4 h-4 text-[#64748B] transition-transform duration-200 ${
              ...
              <AnimatePresence>
                {isUserMenuOpen && (
                  ...
                  >
                    <div className="p-5 border-b border-border">
                      <p className="font-semibold text-[#1E293B]">Kavya</p>
                      <p className="text-sm text-[#64748B] mt-0.5">Class 10A</p>
                    </div>
                    <div className="p-2">
                      <Link to="/settings">
                        <motion.button

...
const menuItems = [
  ...
  { path: "/live-monitoring", label: "Live Class Monitoring", icon: Activity },
  { path: "/reports", label: "Engagement Reports", icon: BarChart3 },
  { path: "/students", label: "Student Insights", icon: Users },
  { path: "/ai-suggestions", label: "AI Suggestions", icon: Sparkles },
  { path: "/past-classes", label: "Past Classes", icon: History },
  ...
  return (
    <>
      ...
      <motion.div
        ...
        animate={{ x: 0 }}
        className={`w-64 h-screen bg-white border-r border-[rgba(0,0,0,0.08)] flex flex-col sticky top-0 z-50 ${
          ...
          <div className="space-y-1">
            {menuItems.map((item) => {
              ...
              return (
                ...
                >
                  <motion.div
                    className={`flex items-center gap-3 px-4 py-3 rounded-[12px] transition-all duration-300 ${
                      isActive

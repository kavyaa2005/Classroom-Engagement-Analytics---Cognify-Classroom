...
export function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#0F172A] flex items-center justify-center p-4 relative overflow-hidden">
            {/* Animated blobs */}
            <motion.div className="absolute top-[-150px] left-[-100px] w-[500px] h-[500px] bg-[#3B82F6]/20 rounded-full blur-[120px]"
                animate={{ x: [0, 40, 0], y: [0, 30, 0] }} transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }} />
            <motion.div className="absolute bottom-[-100px] right-[-100px] w-[400px] h-[400px] bg-[#0D9488]/20 rounded-full blur-[100px]"
                animate={{ x: [0, -30, 0], y: [0, -40, 0] }} transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }} />
            <motion.div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-[#8B5CF6]/10 rounded-full blur-[80px]"
                ...
                <div className="bg-white/[0.07] backdrop-blur-2xl rounded-3xl border border-white/10 shadow-[0_40px_80px_rgba(0,0,0,0.4)] overflow-hidden">
                    ...
                    <div className="p-8 space-y-6">
                        ...
                        <p className="text-center text-sm text-white/40">
                            ...
                            <Link to="/register" className="text-[#60A5FA] hover:text-[#93C5FD] font-medium transition-colors">
                                Register
                            </Link>
                        </p>
                    </div>

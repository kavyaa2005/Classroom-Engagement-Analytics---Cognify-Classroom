...
const menuItems = [
  ...
  { path: "/admin/ai-model", label: "AI Model Status", icon: Brain },
  { path: "/admin/notifications", label: "Notifications", icon: Bell },
  { path: "/admin/settings", label: "Settings", icon: Settings },
  { path: "/admin/privacy", label: "Privacy & Compliance", icon: Shield },
];
              ...
              {menuItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 ${active
            ...
            <div className="flex items-center gap-3">
                    ...
                    <div className="max-h-96 overflow-y-auto">
                      {[1, 2, 3].map((i) => (
                        <div key={i} className="p-4 border-b border-gray-50 hover:bg-gray-50 cursor-pointer">
                          <p className="text-sm text-[#1F2937]">Class 8B engagement dropped below 50%</p>
              ...
              <div className="relative">
                ...
                {showProfileDropdown && (
                  ...
                  >
                    <div className="p-4 border-b border-gray-100">
                      <p className="font-semibold text-[#1F2937]">{user?.name ?? "Admin User"}</p>
                      <p className="text-sm text-[#6B7280]">{user?.email ?? "admin@engageai.com"}</p>
                    </div>
                    <div className="p-2">
                      <button
